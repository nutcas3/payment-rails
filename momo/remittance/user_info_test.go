...
func TestGetBasicUserInfo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := r.GetBasicUserInfo(args.ctx, args.accHolderMsisdn)
...
func TestUserInfoWithConsent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := r.GetUserInfoWithConsent(args.ctx)
...
func TestValidateAccountHolderStatus(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := d.ValidateAccountHolderStatus(args.ctx, args.accHolderIDType, args.accHolderID)
