...
func main() {
	...
	fmt.Printf("Single Invoice Creation Response:\n")
	...
	if response.ResCode == "200" {
		...
		fmt.Println("The customer will receive an SMS with invoice details.")
		...
		fmt.Println("\nFailed to create invoice. Please check your request parameters.")
	}
}
